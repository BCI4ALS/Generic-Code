function [] = plot_spectrum(pwelchRight,pwelchLeft,freqVec,numChannels,chanNames)
...
for index = 1:numChannels
    ...
    plot(freqVec,pwelchRight(index,:));
    plot(freqVec,pwelchLeft(index,:));
    ...
    plot(freqVec,abs(pwelchRight(index,:)-pwelchLeft(index,:)),'color','g');
    ylabel('Power'); xlabel('Frequency [Hz]');
    legend("Diff");
